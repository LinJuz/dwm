...
static const char col_cyan[]        = "#303649";
static const char col_gray5[]       = "#1c1d20";
static const char col_blue[]        = "#7993b0";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_cyan },
	[SchemeSel]  = { col_gray2, col_cyan,  col_blue  },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray5, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
